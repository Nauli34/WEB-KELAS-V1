...
const Schedule = () => {
    ...
    // Menentukan kelompok piket berdasark an hari
    piketGroup = [
        ["Shania", "Velisya", "Nova", "Ferdiansyah", "Dila", "Fikri", "Delfi", "Rahayu" ],
        ["Latifa", "Dian", "Reisyah", "Raya", "Melda", "chaerunisa", "sofy", "aulia", "mumtahanah"],
        ["Sekar", "Ria", "Hani", "Jenny", "Anggie", "Farel", "Bunga"],
        ["Putri", "Maharani", "Bara", "Roby", "Zahwa", "Nadiera", "wulida", "zaki"],
        ["-", "-", "-", "-"],
    ]
